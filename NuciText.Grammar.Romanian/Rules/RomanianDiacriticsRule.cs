...
internal sealed class RomanianDiacriticsRule : PatternReplacementRuleBase
{
    ...
    protected override string DoApply(string text)
    {
        ...
        result = RegexReplaceMatchingFirstLetterCase(result, @"\b[IÎiî]n([glmnrșz])", "în$1");
        ...
        result = RegexReplaceMatchingFirstLetterCase(result, @"\b[IÎiî]ndru", "îndru$1");
        ...
        result = RegexReplaceMatchingFirstLetterCase(result, @"\b[IÎiî]nt([aăâr])", "înt$1");
        ...
        result = Regex.Replace(result, @"cepti", "cepți");
        ...
        result = Regex.Replace(result, @"rtos", "rțos");
        ...
        result = Regex.Replace(result, @"unator", "unător");
        result = Regex.Replace(result, @"upar", "upăr");
        result = Regex.Replace(result, @"urator", "urător");
