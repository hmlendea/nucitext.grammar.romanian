...
internal sealed class RomanianDiacriticsRule : PatternReplacementRuleBase
{
    ...
    protected override string DoApply(string text)
    {
        ...
        result = Regex.Replace(result, @"\b([Mm])antu", "$1ântu");
        result = Regex.Replace(result, @"\b([Mm])inti", "$1inți");
        ...
        result = RegexReplaceMatchingFirstLetterCase(result, @"\b[IÎiî]mb([ăâr])", "îmb$1");
        result = RegexReplaceMatchingFirstLetterCase(result, @"\b[IÎiî]mbar", "îmbâr");
        ...
        result = RegexReplaceMatchingFirstLetterCase(result, @"\b[IÎiî]nse([at])", "înse$1");
        ...
        result = RegexReplaceMatchingFirstLetterCase(result, @"\b[IÎiî]nsera", "însera");
        ...
        result = Regex.Replace(result, @"([Ll])asat", "$1ăsat");
        ...
        result = Regex.Replace(result, @"([Mm])ahn", "$1âhn");
        ...
        result = Regex.Replace(result, @"([Mm])anz", "$1ânz");
        result = Regex.Replace(result, @"([Mm])arit", "$1ărit");
        result = Regex.Replace(result, @"([Mm])asin", "$1așin");
        result = Regex.Replace(result, @"([Mm])asur", "$1ăsur");
        ...
        result = Regex.Replace(result, @"([Nn])ein([dfr])", "$1eîn$2");
        ...
        result = Regex.Replace(result, @"([Zz])amis", "$1ămis");
        ...
        result = Regex.Replace(result, @"([bc])arl([aeiou])", "$1ârl$2");
        ...
        result = Regex.Replace(result, @"([uz])minti", "$1minți");
        ...
        result = Regex.Replace(result, @"cinator", "cinător");
        ...
        result = Regex.Replace(result, @"epad", "epăd");
        ...
        result = Regex.Replace(result, @"ntui([emnrt])", "nțui$1");
        result = Regex.Replace(result, @"ntui([emnrt])", "nțui$1");
        ...
        result = Regex.Replace(result, @"resal", "reșal");
        ...
        result = Regex.Replace(result, @"([i])n[sș]a[tț](i|ii|ile|ilor|iu|iul|iule|iului)\b", "$1nșaț$2");
        result = Regex.Replace(result, @"([i])n[sș]at(e|ei|ele|elor|u|ul|ule|ului)?\b", "$1nșat$2");
        ...
        result = Regex.Replace(result, @"es(i|ii|ilor|ti|u|ul|ule|ului)?\b", "eș$1");
        ...
        result = Regex.Replace(result, @"ins(i|ii|ile|ilor)\b", "inș$1");
        ...
        result = Regex.Replace(result, @"n([cg])ator(i|ii|iile|iilor|ile|ilor|u|ul|ule|ului)?\b", "n$1ător$2");
        ...
        result = Regex.Replace(result, @"ran(e|ei|eii|i|ii|ile|ilor|u|ul|ule|ului)?\b", "rân$1");
        result = Regex.Replace(result, @"ranesc\b", "rănesc");
        result = Regex.Replace(result, @"rar(ia|iei|iile|iilor)\b", "răr$1");
        result = Regex.Replace(result, @"ras(i|ii|ile|ilor)\b", "raș$1");
        result = Regex.Replace(result, @"rcut(a|e)\b", "rcuț$1");
        result = Regex.Replace(result, @"ret(i|ii|ile|ilor)?\b", "reț$1");
        result = Regex.Replace(result, @"risca\b", "rișca");
        result = Regex.Replace(result, @"rs(i|ia|ie|iei|ii|iile|iilor|ile|ilor|im|ite|iti|itilor|ti|tii|tilor|tiilor)\b", "rș$1");
        result = Regex.Replace(result, @"rt(i|ia|ie|iei|ii|iile|iilor|ile|ilor|im|ite|iti|itilor|ine)\b", "rț$1");
